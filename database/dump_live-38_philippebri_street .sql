...
--
-- Hôte : localhost
-- Généré le : mer. 20 jan. 2021 à 11:18
...
--
-- Base de données : `live-38_philippebri_street`
--
...
-- Fonctions
--
CREATE DEFINER=`philippebri`@`localhost` FUNCTION `get_distance_metres` (`lat1` DOUBLE, `lng1` DOUBLE, `lat2` DOUBLE, `lng2` DOUBLE) RETURNS DOUBLE BEGIN
    DECLARE rlo1 DOUBLE;
    DECLARE rla1 DOUBLE;
    DECLARE rlo2 DOUBLE;
    DECLARE rla2 DOUBLE;
